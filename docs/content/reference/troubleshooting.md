...
Most of these come down to network reality or how hf serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

hf rate-limits like any public site. hf already paces
...
Where a surface is gated, hf reads a cookie or token you supply
...
`hf`, add that directory to your `PATH`. See
