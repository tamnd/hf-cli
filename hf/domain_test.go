...
// HTTP behaviour is covered in hf_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "hf://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("hf", "about")
	if err != nil || got.String() != "hf://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want hf://page/about", got.String(), err)
	}
}
